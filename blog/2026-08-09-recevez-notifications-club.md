...
## Recevez les notifications sur votre téléphone

Les instructions se trouvent sur la page [Abonnez-vous](/abonnez-vous).
...
L'objectif n'est pas de fermer le groupe Messenger. Au contraire, les deux plateformes se complètent parfaitement:
- **Le site web** sert à publier les articles, les guides, les annonces officielles et les informations importantes. Ces publications pourront rejoindre à la fois les membres et le public.
- **Messenger** reste l'espace privilégié pour poser des questions, partager vos expériences et échanger avec la communauté. Le groupe de discussion est réservé pour les membres du club seulement.

Chaque outil remplit ainsi le rôle pour lequel il est le plus efficace.

Vous profiterez d'une information mieux organisée, plus facile à retrouver et toujours accessible, tout en conservant la convivialité de notre communauté.
